...
const seoTranslations = {
  en: {
    ...
    faq1_a: "Depending on the complexity and scale chosen, it is performed by 1 to 12 certified Vedic Pandits trained in sacred centers.",
  ...
  hi: {
    ...
    faq1_a: "चयनित जटिलता और पैमाने के आधार पर, यह पवित्र केंद्रों से प्रशिक्षित 1 से 12 प्रमाणित वैदिक पंडितों द्वारा किया जाता है।",
  ...
  gu: {
    ...
    faq1_a: "પસંદ કરેલી પૂજાની શ્રેણી અને માપદંડના આધારે, તે પવિત્ર કેન્દ્રોથી શિક્ષિત ૧ થી ૧૨ પ્રમાણિત વૈદિક પંડિતો દ્વારા કરવામાં આવે છે.",
    faq2_q: "મારે કઈ સામગ્રી તૈયાર કરવાની જરૂર છે?",
    ...
    faq4_a: "સંપૂર્ણ ઉપવાસ રાખવો ઉત્તમ છે, પરંતુ ફળાહાર અને દૂધ જેવા હળવા સાત્વિક આહારની છૂટ છે. મુખ્ય પૂજા કરનારે પવિત્રતા જાળવવી જોઈએ।"
  }
};
