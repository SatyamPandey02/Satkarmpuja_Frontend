...
const poojaImages: Record<string, string> = {
  "navagraha-shanti": "/assets/poojas/navagraha_shanti_new.png",
  "surya-grah-shanti": "/assets/poojas/pooja-surya-grah.png",
  "chandra-grah-shanti": "/assets/poojas/chandra_grah.png",
  "mangal-grah-shanti": "/assets/poojas/pooja-mangal-grah.png",
  "budh-grah-shanti": "/assets/poojas/budh_grah.png",
  "guru-grah-shanti": "/assets/poojas/Guru.png",
  "shukra-grah-shanti": "/assets/poojas/Shukr.png",
  "shani-grah-shanti": "/assets/poojas/Shani.png",
  "rahu-grah-shanti": "/assets/poojas/Rahu.png",
  "ketu-grah-shanti": "/assets/poojas/Ketu.png",
  "rudrabhishek": "/assets/poojas/Rudrabhishek.png",
  "durga-saptashati": "/assets/poojas/Durga.png",
  "ganesh-pooja": "/assets/poojas/Ganesh.png",
  "hanuman-pooja": "/assets/poojas/Hanuman.png",
  "vishnu-pooja": "/assets/poojas/Vishnu.png",
  "lakshmi-pooja": "/assets/poojas/Laxshmi.png",
  "maha-mrityunjay": "/assets/poojas/Rudrabhishek.png",
  "maha-mrityunjay-havan": "/assets/poojas/Rudrabhisek_havan.png",
  "durga-navarna": "/assets/poojas/Durga.png",
  "durga-navarna-havan": "/assets/poojas/Durga_puja_havan.png",
  "kaal-sarp-dosh": "/assets/poojas/kal_sarp_dosh.png",
  "surya-shani-dosh": "/assets/poojas/sury-shani.png",
  "surya-rahu-dosh": "/assets/poojas/sury-rahu.png",
  "surya-ketu-dosh": "/assets/poojas/sury-ketu.png",
  "surya-mangal-dosh": "/assets/poojas/sury-mangal.png",
  "surya-chandra-amavasya-dosh": "/assets/poojas/sury-chandr.png",
  "shani-rahu-dosh": "/assets/poojas/shani-rahu.png",
  "shani-ketu-dosh": "/assets/poojas/shani-ketu.png",
  "shani-chandra-vish-yog-dosh": "/assets/poojas/shani-chandr.png",
  "mangal-rahu-dosh": "/assets/poojas/mangal-rahu.png",
  "mangal-ketu-dosh": "/assets/poojas/mangal-ketu.png",
  "guru-rahu-dosh": "/assets/poojas/guru-rahu.png",
  "guru-ketu-dosh": "/assets/poojas/guru-ketu.png",
  "chandra-rahu-dosh": "/assets/poojas/chandr-rahu.png",
  "chandra-ketu-dosh": "/assets/poojas/Chandr-ketu.png",
  "laghu-rudra": "/assets/poojas/lagurudr.png",
  "ganesh-atharvashirsha-laddu-havan": "/assets/poojas/Ganesh.png",
  "pathatmak-laghu-rudra": "/assets/poojas/lagurudr.png",
  "navchandi-yagna": "/assets/poojas/Navchandi.png",
  "revati-nakshatra": "/assets/poojas/revati-nakshatra.png",
  "mool-nakshatra": "/assets/poojas/moola-nakshatra.png",
  "magha-nakshatra": "/assets/poojas/magha-nakshatra.png",
  "jyestha-nakshatra": "/assets/poojas/jyestha-nakshatra.png",
  "ashwini-nakshatra": "/assets/poojas/ashwini-nakshatra.png",
  "ashlesha-nakshatra": "/assets/poojas/Ashlesh-nakshatra.png",
  "griha-pravesh": "/assets/poojas/dev_pooja.png",
  "satyanarayan-katha": "/assets/poojas/dev_pooja.png",
};
                  ...
                  <div className="p-8 md:p-10 flex flex-col">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-8 flex-1 max-h-44 overflow-y-auto pr-1">
                      {cat.pujas.map((poojaName) => {
                        ...
                        const thumbImg = poojaImages[key];
...
function BlogPage({ onNavigate }: { onNavigate: (page: Page, key?: string | number) => void }) {
...
function BlogDetailPage({ postId, onNavigate }: BlogDetailPageProps) {
            ...
            <div className="space-y-10">
              ...
              <div className="gradient-gold rounded-3xl p-8 text-center text-white shadow-glow-gold relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <h3 className="font-display text-2xl font-bold mb-3">Experience Sacred Vedic Blessings</h3>
                  <p className="font-body text-white/90 text-sm mb-6 leading-relaxed">
                    Book a personalized puja, patha, or mantra jaap with our highly qualified Vedic Pandits.
                  </p>
                  <button
                    onClick={() => onNavigate("book")}
              ...
              <div className="bg-saffron-50/50 rounded-3xl p-8 border border-gold-100">
                <h3 className="font-display text-xl font-bold text-maroon-700 mb-6">Recent Articles</h3>
                  ...
                  {relatedPosts.map(related => (
                    ...
                    >
                      <div className="w-16 h-16 rounded-xl overflow-hidden shrink-0 border border-gold-100">
                        <img src={related.image} alt={related.title} className="w-full h-full object-cover transition duration-300 group-hover:scale-105" />
                      </div>
                      <div>
      ...
      <section className="py-16 bg-saffron-100 om-pattern text-center">
        <div className="max-w-2xl mx-auto px-4">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-maroon-700 mb-3">
            Connecting Devotees to Divine Blessings
          </h2>
          <p className="font-body text-muted-foreground mb-6">
            Explore our traditional puja categories or schedule a consultation with our pandit ji today.
          </p>
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-16 md:pt-20">
        <div key={currentPage} className="page-enter">
          ...
          {currentPage === "blog-detail" && <BlogDetailPage postId={currentBlogId} onNavigate={navigateTo} />}
